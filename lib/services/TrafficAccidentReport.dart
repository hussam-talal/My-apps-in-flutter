...
class TrafficAccidentReport extends StatefulWidget {
  ...
  @override
  TrafficAccidentReportState createState() => TrafficAccidentReportState();
}

class TrafficAccidentReportState extends State<TrafficAccidentReport> {
